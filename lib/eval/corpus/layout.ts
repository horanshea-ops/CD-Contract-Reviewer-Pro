...
const SECTION_TITLE: Record<string, string> = {
  ...
  hotel_cancellation: "Cancellation by Hotel",
  function_space: "Function Space",
  facilities_services: "Hotel Facilities and Services",
  future_rate_cap: "Future Room Rates",
  nondiscrimination: "Nondiscrimination",
  reservation_procedures: "Reservation Procedures",
  banquet_service_levels: "Banquet Service Levels",
  av_internet: "Audio-Visual and Internet",
};
